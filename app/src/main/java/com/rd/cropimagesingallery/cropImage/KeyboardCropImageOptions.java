...
public class KeyboardCropImageOptions implements Parcelable {
  public static final Creator<KeyboardCropImageOptions> CREATOR =
      new Creator<KeyboardCropImageOptions>() {
        @Override
        public KeyboardCropImageOptions createFromParcel(Parcel in) {
          return new KeyboardCropImageOptions(in);
        }
        @Override
        public KeyboardCropImageOptions[] newArray(int size) {
          return new KeyboardCropImageOptions[size];
        }
      };
  public KeyboardCropImageView.imageCropShape cropShape;
  public float snapRadius;
  public float touchRadius;
  public KeyboardCropImageView.imageGuidelines guidelines;
  public KeyboardCropImageView.imageScaleType scaleType;
  ...
  public KeyboardCropImageView.imageRequestSizeOptions outputRequestSizeOptions;
  ...
  public KeyboardCropImageOptions() {

    DisplayMetrics dm = Resources.getSystem().getDisplayMetrics();

    cropShape = KeyboardCropImageView.imageCropShape.RECTANGLE;
    ...
    guidelines = KeyboardCropImageView.imageGuidelines.ON_TOUCH;
    scaleType = KeyboardCropImageView.imageScaleType.FIT_CENTER;
    ...
    outputRequestSizeOptions = KeyboardCropImageView.imageRequestSizeOptions.NONE;
    noOutputImage = false;
  ...
  protected KeyboardCropImageOptions(Parcel in) {
    cropShape = KeyboardCropImageView.imageCropShape.values()[in.readInt()];
    snapRadius = in.readFloat();
    touchRadius = in.readFloat();
    guidelines = KeyboardCropImageView.imageGuidelines.values()[in.readInt()];
    scaleType = KeyboardCropImageView.imageScaleType.values()[in.readInt()];
    ...
    outputRequestSizeOptions = KeyboardCropImageView.imageRequestSizeOptions.values()[in.readInt()];
